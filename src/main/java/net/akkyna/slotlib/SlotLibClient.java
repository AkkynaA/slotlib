...
import net.akkyna.slotlib.client.ClientEventHandler;
import net.akkyna.slotlib.client.KeyRegistry;
import net.akkyna.slotlib.client.gui.GuiEventHandler;
import net.akkyna.slotlib.client.gui.SlotLibScreen;
